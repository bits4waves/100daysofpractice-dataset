...
Now, let’s test fetching the post data for the first shorcode:

#+BEGIN_SRC python
import instaloader

I = Instaloader()
post = Post.from_shortcode(I.context, '008-CMh_h-')
#+END_SRC

#+RESULTS:
: Traceback (most recent call last):
:   File "<stdin>", line 1, in <module>
:   File "/tmp/babel-gxsaLR/python-Gb2dlI", line 1, in <module>
:     import instaloader
