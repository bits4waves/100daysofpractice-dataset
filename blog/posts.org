...
:ID:       o2b:20f4ba67-bdd1-49c6-b848-453e501f86c7
:POST_DATE: [2021-04-08 Thu 17:18]
:POSTID:   377
:END:
...
#+RESULTS:
: 
: ~/sci/100daysofpractice-dataset/shortcodes ~/sci/100daysofpractice-dataset/shortcodes ~/sci/100daysofpractice-dataset/shortcodes ~/sci/100daysofpractice-dataset ~/sci/100daysofpractice-dataset ~/sci/100daysofpractice-dataset ~/sci/100daysofpractice-dataset ~/sci/100daysofpractice-dataset/blog
: (venv) rafa@bach:~/sci/100daysofpractice-dataset/shortcodes$ 4.7.1

Okidoki.
Let’s add it to the =Makefile=:
