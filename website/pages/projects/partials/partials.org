...
#+HTML: <img src="https://bits4waves.files.wordpress.com/2021/04/sound-digraph.png" alt="Digraph depicting the central role of the partials in the sound structure."></img>
