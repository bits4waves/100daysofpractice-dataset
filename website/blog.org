...
:ID:       b695ef76-e0e1-4198-b8d1-7baedb07b528
:END:

This expression got fame with Newton in the 1600’s, but it had been used already as early as the 1100’s.
Here at Bits4Waves we like ideas that linger for 1000 years or so.
...
- [ ] update the code with the new script
- [ ] unify the new shortcodes
...
#+RESULTS:
: 
: ~/sci/100daysofpractice-dataset/src ~/sci/100daysofpractice-dataset/src ~/sci/100daysofpractice-dataset ~/sci/100daysofpractice-dataset ~/sci/100daysofpractice-dataset/website
: rafa@bach:~/sci/100daysofpractice-dataset/src$ rm 'src/get-shortcodes.py'
...
First, let’s fix a fundamental problem with the =Makefile=: the targets must have the file extension!
